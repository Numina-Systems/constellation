...
- `src/subconscious/` -- Interest registry, curiosity threads, engagement decay, exploration logging, impulse continuation (LLM-judged multi-round follow-up for impulse and introspection events) (PostgreSQL-backed)
